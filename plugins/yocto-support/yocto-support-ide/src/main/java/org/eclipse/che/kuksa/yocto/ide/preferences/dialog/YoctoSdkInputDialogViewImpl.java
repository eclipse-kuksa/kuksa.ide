 ...
 * @author Pedro Cuadra
 */
public class YoctoSdkInputDialogViewImpl extends Window implements YoctoSdkInputDialogView {

  /** The UI binder instance. */
  private static ConfirmWindowUiBinder uiBinder = GWT.create(ConfirmWindowUiBinder.class);
  /** The window footer. */
  private final YoctoSdkInputDialogFooter footer;
  ...
  @Inject
  public YoctoSdkInputDialogViewImpl(final @NotNull YoctoSdkInputDialogFooter footer) {
  ...
  void onNameKeyUp(KeyUpEvent event) {
    delegate.inputValueChanged(YoctoSdkInputDialogView.NAME_FIELD);
  }

  @UiHandler("versionValue")
  void onVersionKeyUp(KeyUpEvent event) {
    delegate.inputValueChanged(YoctoSdkInputDialogView.VERSION_FIELD);
  }

  @UiHandler("urlValue")
  void onUrlKeyUp(KeyUpEvent event) {
    delegate.inputValueChanged(YoctoSdkInputDialogView.URL_FIELD);
  }

  /** The UI binder interface for this components. */
  interface ConfirmWindowUiBinder extends UiBinder<Widget, YoctoSdkInputDialogViewImpl> {}
}
