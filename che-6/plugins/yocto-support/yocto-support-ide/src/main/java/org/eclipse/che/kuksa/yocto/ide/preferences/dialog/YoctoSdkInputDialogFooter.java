...
import static org.eclipse.che.kuksa.yocto.ide.preferences.dialog.YoctoSdkInputDialogView.ActionDelegate;
 ...
 * @author Pedro Cuadra
 */
public class YoctoSdkInputDialogFooter implements IsWidget {
  ...
  @Inject
  public YoctoSdkInputDialogFooter(
  ...
  interface ConfirmWindowFooterUiBinder extends UiBinder<HTMLPanel, YoctoSdkInputDialogFooter> {}
}
